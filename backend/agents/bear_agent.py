...
def generate_bear_case(stock_data: StockData) -> str:
    system_prompt = (
        "You are a skeptical Wall Street Bear Analyst. "
        "Your job is to look at the financial data provided and argue rigorously "
        "why this stock is highly risky or overvalued. Focus on macroeconomic risks, overvaluation metrics, and potential headwinds."
    ...
    user_prompt = (
        ...
        "Provide a concise, 2-3 paragraph bear case."
    )
